...
const Navbar = () => {
  ...
  return (
    <nav
      className={`bg-custom-grey-11 border-custom-grey-15 sticky top-4 flex w-full flex-col items-center justify-between backdrop:backdrop-blur-2xl lg:top-8 ${toggled ? "rounded-2xl" : "rounded-full"} border-[1px] px-[12px] py-[10px] md:px-[20px] md:py-[12px] lg:px-[20px] lg:py-[16px]`}
    >
